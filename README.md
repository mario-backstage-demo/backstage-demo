...
Fork the following repo https://github.com/mario-backstage-demo/backstage-demo to your organization.
...
cd backstage-demo
find . -type f -not -path '*/\.git/*' -exec sed -i "s/mario-backstage-demo/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/mario-backstage-demo/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/mloriedo-devworkspaces.devcluster.openshift.com/${base_domain}/g" {} +
git add -A
...
Fork the following repo https://github.com/mario-backstage-demo/shared-workflows to your organization.
Then execute the following commands
...
Fork the following repo https://github.com/mario-backstage-demo/software-templates to your organization.
Then execute the following commands
...
Fork the following repo https://github.com/mario-backstage-demo/backstage-app-demo to your organization.
